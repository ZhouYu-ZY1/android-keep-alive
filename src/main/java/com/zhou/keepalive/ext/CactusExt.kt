...
import com.zhou.keepalive.Cactus
import com.zhou.keepalive.callback.AppBackgroundCallback
import com.zhou.keepalive.entity.CactusConfig
import com.zhou.keepalive.entity.Constant
import com.zhou.keepalive.pix.OnePixActivity
import com.zhou.keepalive.receiver.StopReceiver
import com.zhou.keepalive.service.CactusJobService
import com.zhou.keepalive.service.LocalService
import com.zhou.keepalive.service.RemoteService
import com.zhou.keepalive.workmanager.CactusWorker
 ...
 */
fun Context.keepAliveService(block: Cactus.() -> Unit) =
